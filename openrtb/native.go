...
// Validation errors
var (
	ErrInvalidRequest = errors.New("openrtb: native has no request")
)

// Native This object represents a native type impression. Native ad units are intended to blend seamlessly into
