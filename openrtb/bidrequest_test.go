	...
	It("should parse correctly", func() {
		Expect(subject).To(Equal(&BidRequest{
			...
			Imp: []Impression{
				{
					ID:     "1",
					Banner: &Banner{Width: 300, Height: 250, Position: AdPosAboveFold, BAttr: []int{13}},
				},
			},
			Site: &Site{
				ID:        "234563",
				Name:      "Site ABCD",
				Domain:    "siteabcd.com",
				Category:  []string{"IAB2-1", "IAB2-2"},
				Publisher: &Publisher{ID: "pub12345", Name: "Publisher A"},
				Content: &Content{
					Keywords: "keyword a,keyword b,keyword c",
				},
				Page:       "http://siteabcd.com/page.htm",
				Referrence: "http://referringsite.com/referringpage.htm",
			},
			Device: &Device{
