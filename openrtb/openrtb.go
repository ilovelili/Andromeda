...
// ThirdParty Abstract third-party
...
// Publisher The publisher object itself and all of its parameters are optional, so default values are not
// provided. If an optional parameter is not specified, it should be considered unknown.
type Publisher ThirdParty

// Producer The producer is useful when content where the ad is shown is syndicated, and may appear on a
