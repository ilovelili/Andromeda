...
// BidRequest The top-level bid request object contains a globally unique bid request or auction ID.  This "id"
...
type BidRequest struct {
	...
	BApp        []string        `json:"bapp,omitempty"`    // Array of strings of Block list of applications by their platform-specific exchange-independent application identifiers
