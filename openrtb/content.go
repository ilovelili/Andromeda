...
// Content This object describes the content in which the impression will appear, which may be syndicated or nonsyndicated
...
type Content struct {
	...
	Isrc               string          `json:"isrc,omitempty"`               // Content isrc
	...
	ProductionQuality  int             `json:"prodq,omitempty"`              // Production quality
	VideoQuality       int             `json:"videoquality,omitempty"`       // Video quality per IAB's classification. (DEPRECATED)
	...
	Data               []*Data         `json:"data,omitempty"`               // Additional content data. Each Data object (Section 3.2.16) represents a different data source.
